...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -45.45
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -23
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -6.2

  #define Z_RAISE_BEFORE_HOMING 8       // (in mm) Raise Z before homing (G28) for Probe Clearance.
                                        // Be sure you have this distance over your Z_MAX_POS in case

  #define XY_TRAVEL_SPEED 12500         // X and Y axis travel speed between probes, in mm/min
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.19,80.19,2560,458.3}  // default steps per unit for Ultimaker
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 85,180} // X,Y,Z Axis Extend and Retract angles
