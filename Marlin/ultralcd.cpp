...
static void lcd_calibration_wizard();
...
void lcd_calibration_wizard()
{

   enquecommand_P(PSTR("G33"));
   refresh_cmd_timeout();
   float voltes1;
  ...
  if (lcdDrawUpdate)
  {
    lcd_implementation_drawedit(PSTR("cargol 1"), ftostr31(voltes1));
  }
}
...
static void lcd_prepare_menu()
{
   ...
   MENU_ITEM(function, MSG_CAL_WIZ, lcd_calibration_wizard);
