...
// M777 - Turns on red LED
// M778 - Turns off red LED
// M779 - Blinks red LED
// M888 - Turns on green LED
// M889 - Turns off green LED
// M900 - Turns on yellow LED
// M901 - Turns off yellow LED
// M555 - Blinks red LED and beeps
...
int RED_LED_PIN = 63;
int GREEN_LED_PIN = 59;
int YELLOW_LED_PIN = 64;
...
void setup()
{
  pinMode(RED_LED_PIN, OUTPUT);      //configura el pin del LED como salida
  pinMode(GREEN_LED_PIN, OUTPUT);      //configura el pin del LED como salida
  pinMode(YELLOW_LED_PIN, OUTPUT);      //configura el pin del LED como salida
  setup_killpin();
  setup_powerhold();
...
void process_commands()
{
  ...
  if(code_seen('G'))
  {
    ...
    case 33: // G33 Calibration Wizard
        {
...
//G29
           ...
           float cargol_1_x = -14;
           float cargol_1_y = 160;
           
           float cargol_2_x = -14;
           float cargol_2_y = 0;
           
           float cargol_3_x = 258;
           float cargol_3_y = 80;
  ...
  else if(code_seen('M'))
  {
    ...
    case 777: // M777 - Turns on red LED
     {
      digitalWrite(RED_LED_PIN, HIGH);
     }
    break;
    case 778: // M778 -  Turns off red LED
     {
    ...
    case 888: // Turns on green LED
     {
      digitalWrite(GREEN_LED_PIN, HIGH);
     }
    break;
    case 889: // Turns off green LED
     {
    ...
    case 900: // Turns on yellow LED
     {
      digitalWrite(YELLOW_LED_PIN, HIGH);
     }
    break;
    case 901: // Turns off yellow LED
     {
    ...
    case 555: //M555: Blinks red LED and beeps
    {
      for (int i=0; i<20; i++)
      {
        tone(BEEPER, 800);
